 ...
 *
 * <p>Eligibility tests have been moved to {@link EligibilityEngineTest}
 * following extraction of the rules engine into its own component.
 */
...
class PatientServiceTest {
    ...
    void setUp() {
        savedPatient = Patient.builder()
            .id(1L).name("Alice Nwosu").age(42).condition("Breast cancer")
            .build();
    }
    ...
    class Create {
        ...
        void create_savesAndReturns() {
            ...
            req.setName("Bob Mensah"); req.setAge(55); req.setCondition("NSCLC");
    ...
    class Update {
        ...
        void update_fieldsChangedCorrectly() {
            ...
            PatientRequest req = new PatientRequest();
            req.setName("Alice Updated"); req.setAge(43); req.setCondition("Colorectal");
